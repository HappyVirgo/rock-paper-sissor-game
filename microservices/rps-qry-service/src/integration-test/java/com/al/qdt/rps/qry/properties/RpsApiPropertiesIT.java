...
class RpsApiPropertiesIT extends AbstractIntegrationTest {
    ...
    private static final String DEV_SERVER_BASE_URL = "http://localhost:8082/rps-qry-api";
    private static final String DEV_SERVER_DESCRIPTION = "Dev server";
    private static final String PROD_SERVER_BASE_URL = "http://localhost:8080/rps-qry-api";
